...
function isFragmentSpread(selection: SelectionNode): selection is FragmentSpreadNode {
  return (selection.kind === 'FragmentSpread');
}

// Checks if a given GraphQL definition is a FragmentDefinition.
function isFragmentDefinition(selection: DefinitionNode): selection is FragmentDefinitionNode {
...
function isQueryDefinition(defn: DefinitionNode): defn is OperationDefinitionNode {
